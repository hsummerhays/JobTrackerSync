---
name: add_contact
description: Generate a standard vCard (.vcf) file or import link to add contacts into Google Contacts.
---
# Add Contact Skill

Use this skill whenever the user asks to add or save contacts to Google Contacts.
...
3. Return:
   ...
   - A direct link to [Google Contacts Import](https://contacts.google.com/) where uploading the file adds them with one click.
