...
def clean_existing_tracker(tracker_path):
    ...
    try:
        ...
        for row in rows:
            ...
            if is_aggregator_placeholder(company):
            ...
            for job in jobs_list:
                ...
                if jid:
                    cursor.execute("""
                        ...
                        VALUES (?, ?, ?, ?, ?, datetime('now'), 'system', 'parser')
